...
func NewOutput() *Output {
	return &Output{
		Colors: map[highlight.TokenType]*color.Color{
			...
			highlight.Number:      color.New(color.FgWhite),
			highlight.String:      color.New(color.FgHiGreen),
			highlight.Attribute:   color.New(color.FgGreen),
			highlight.Assignment:  color.New(color.FgBlue),
			highlight.Operator:    color.New(color.FgGreen),
			highlight.Punctuation: color.New(color.FgYellow),
			highlight.Constant:    color.New(color.FgCyan, color.Bold),
